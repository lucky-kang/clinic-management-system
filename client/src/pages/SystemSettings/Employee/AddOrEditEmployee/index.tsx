...
const AddOrEditEmployee: React.FC<AddOrEditEmployeeProps> = props => {
  ...
  /** 编辑医生时，医生信息的回显 */
  useEffect(() => {
    console.log(operationType,'operationType',employeeDetail)
    ...
    <div className="global-container">
      ...
      >
        <Card
          ...
          title={<IconTitle title={`${operationType === 'add' ? '新增' : '编辑'}医生信息`} />
          }
        ...
        >
          <Row gutter={24}>
            <Col {...colProps}>
              <Form.Item label="医生编号" name="number">
                <Input disabled />
              </Form.Item>
            </Col>
            <Col {...colProps}>
          ...
          <Row gutter={24}>
            ...
            <Col {...colProps}>
              <Form.Item label="医生状态" name="status" valuePropName="checked">
                <Switch />
              </Form.Item>
            </Col>
          </Row>
