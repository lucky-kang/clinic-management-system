  ...
  const radios: CurrentBasicDataType[] = [
    {
      ...
      searchPlaceholder: '医生姓名',
      addPath: '/doctor/add-doctor',
      columns: [
        {
          dataIndex: 'key',
          title: '序号',
        ...
        },
        {
          ...
          render: (record: EmployeeType) => <div>
            <Button type="link" onClick={() => { history.push(`/doctor/edit-doctor?id=${record.id}`) }}>编辑</Button>
      ...
      columns: [
        ...
        },
        {
          ...
          render: (record: DepartmentType) => <div>
            <Button type="link" onClick={() => { history.push(`/doctor/edit-department?id=${record.id}`) }}>编辑</Button>
      ...
      columns: [
        ...
        },
        {
          ...
          render: (record: RoleType) => <div>
            <Button type="link" onClick={() => { history.push(`/doctor/edit-role?id=${record.id}`) }}>编辑</Button>
