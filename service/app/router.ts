...
export default (app: Application) => {
  ...
  router.post('/addPatient', controller.patients.create); // 新增患者
  router.post('/updatePatient', controller.patients.update); // 编辑患者
  router.delete('/deletePatient', controller.patients.destroy); // 删除患者
  router.get('/getPatientDetail', controller.patients.show); // 获取患者详情
  router.get('/getOrderList', controller.orders.index); // 获取订单列表
  router.post('/updateCharge', controller.orders.update); // 编辑订单
